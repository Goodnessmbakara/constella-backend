...
similarity_search_user_notes_tool = {
    ...
    "function": {
      ...
      "strict": True,
      "description": "You already have access to the current user's notes. However, if the user asks to look for other notes, then only use this tool call.\\n This finds notes that are similar based on meaning.",
      "parameters": {
        "type": "object",
        "properties": {
          "query": {
...
edit_note_tool_DEPRECATED = {
    "type": "function",
    "function": {
        "name": "edit_note",
        "strict": True,
        "description": "Edit an existing note's title, content and/or tags. Only include the fields that need to be updated.",
        "parameters": {
            "type": "object",
            "properties": {
                "note_uniqueid": {
                ...
                "content": {
                    "type": "string",
                    "description": "(Optional) New content/body for the note."
                },
                "tags": {
                    **TAG_LIST_SCHEMA
                }
...
# 2. Edit the tags of a note only
...
replace_part_of_note_content_tool = {
    ...
    "function": {
        ...
        "parameters": {
            ...
            "required": ["note_uniqueid", "content_part_to_replace", "replacement_content"],
            "additionalProperties": False
        }
    }
}
